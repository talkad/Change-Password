...
public class BTreeNode {
	...
	public String getValue(int index){return getKey()[index];}
	public BTreeNode getChild(int index){return child[index];}
	...
	public BTreeNode[] getChild() {return child;}
	public void setChild(BTreeNode child[]) {this.child = child;}
	...
	{ 
	    ...
	    if (indexDelete < this.count && this.key[indexDelete].equals(key)){ 
	        ...
	        if (this.child[indexDelete].count < this.t) 
	            fill(indexDelete); 
